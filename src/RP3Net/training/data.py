...
FULL_DF_DTYPE_PL = {'created_at': pl.Datetime(), 'source': pl.Categorical(), 'sub_source': pl.Categorical(),
                 ...
                 'cv_fold_full': pl.Categorical(), 'cv_fold_az': pl.Categorical(), 'cv_fold_stockholm': pl.Categorical(),
                 'cv_fold_az_stockholm': pl.Categorical(), 'cv_fold_toronto': pl.Categorical(),
...
class RP3LDM(L.LightningDataModule):
    def __init__(self, hypers) -> None:
        ...
        self.validation_slice = self.hypers.get('validation_slice', 'CV_00')
