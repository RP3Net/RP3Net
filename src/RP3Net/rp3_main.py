...
def setup_args(_args: Optional[list] = None):
    ...
    Outputs a .csv[.gz] file with "id,score,y_hat,logit_0,logit_1,proba_0,proba_1" columns. 
    The y_hat is 1 for expression and 0 for no expression.
    ...
    parser.add_argument("-c", "--config", required=True, help="Model configuration in yaml, or registry entry.", default="RSP3_DEFAULT_CONFIG")
...
MODEL_REGISTRY = {
    'PROTMAN_CONFIG': model.RP3_DEFAULT_CONFIG,
    'PROTMAN_CONFIG_B': model.RP3_CONFIG_B,
}
